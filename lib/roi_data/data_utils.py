...
def quant_compute_targets(ex_rois, gt_rois, stride, weights = (1.0, 1.0, 1.0, 1.0)):
	"""Compute bounding-box regression targets for an image."""
	return box_utils.quantilize_bbox_transform_inv(ex_rois, gt_rois, stride, weights).astype(
		np.float32, copy = False
	)
