...
DATASETS = {
    ...
    'coco_2017_train_200':{
        IM_DIR:
            _DATA_DIR + '/coco/images/train2017',
        ANN_FN:
            _DATA_DIR + '/coco/annotations/instances_train2017_200.json',
    },
    'coco_2017_val': {
        IM_DIR:
    ...
    'coco_2017_val_100': {
        IM_DIR:
            _DATA_DIR + '/coco/images/val2017',
        ANN_FN:
            _DATA_DIR + '/coco/annotations/instances_val2017_100.json',
    },
    'coco_2017_val_5': {
        IM_DIR:
            _DATA_DIR + '/coco/images/val2017',
        ANN_FN:
            _DATA_DIR + '/coco/annotations/instances_val2017_5.json',
    },
