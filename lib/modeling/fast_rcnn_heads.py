...
class fast_rcnn_outputs(nn.Module):
	def __init__(self, dim_in):
		...
		if cfg.RPN.ZEROLOSS:
			for params in self.cls_score._parameters:
				self.cls_score._parameters[params].requires_grad = False
			for params in self.bbox_pred._parameters:
				self.bbox_pred._parameters[params].requires_grad = False
