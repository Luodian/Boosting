...
class Generalized_RCNN(nn.Module):
	...
	def _forward(self, data, im_info, roidb = None, **rpn_kwargs):
		...
		if self.training:
			...
			if cfg.TEST.PROPOSALS_OUT:
				...
				shift_boxes = box_utils.bbox_transform(rpn_ret['rois'][:, 1:5], box_deltas, cfg.MODEL.BBOX_REG_WEIGHTS)
	...
	def roi_feature_transform(self, blobs_in, rpn_ret, blob_rois = 'rois', method = 'RoIPoolF', resolution = 7, spatial_scale = 1. / 16.,
	                          sampling_ratio = 0):
